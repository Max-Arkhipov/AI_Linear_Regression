...
- Удалили дубликаты строк, предварительно откладывая в сторону таргет (стоимость автомобиля), чтобы удалить только те строки, где совпадают все значения кроме цены.
